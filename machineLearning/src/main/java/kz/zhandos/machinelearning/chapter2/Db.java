...
public class Db {
  public static final Map<String, Map<String, Double>> CRITICS =
      new HashMap<String, Map<String, Double>>();
  public static final Map<String, Map<String, Double>> MOVIES =
      new HashMap<String, Map<String, Double>>();
  ...
  static {
    {
      for (Map.Entry<String, Map<String, Double>> e : CRITICS.entrySet()) {
        String critic = e.getKey();
        for (Map.Entry<String, Double> k : e.getValue().entrySet()) {
          String movie = k.getKey();
          Double value = k.getValue();
          if (!MOVIES.containsKey(movie)) {
            Map<String, Double> criticValue = new HashMap<String, Double>();
            MOVIES.put(movie, criticValue);
          }
          if (!MOVIES.get(movie).containsKey(critic)) {
            MOVIES.get(movie).put(critic, value);
          }
        }
